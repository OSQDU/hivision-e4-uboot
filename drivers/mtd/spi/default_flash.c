...
static void spi_flash_reset_4byte_winbond(struct spi_slave *spi, u8 four_byte)
{
	u8 idcode[5];
	if (four_byte) {
...
static int inline spi_flash_checksize(const struct winbond_spi_flash_params *params)
{
