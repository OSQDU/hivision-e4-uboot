/*
 * drivers/mtd/spi_nand/nand_util.c
 *
...
int nand_erase_opts(nand_info_t *meminfo, const nand_erase_options_t *opts)
{
	...
	struct spi_nand_chip *chip = meminfo->priv;
	 ...
	 */
	if (opts->scrub) {
		struct spi_nand_chip *priv_nand = meminfo->priv;
	...
	for (;
		...
		/* format for JFFS2 ? */
		if (opts->jffs2 && meminfo->oobavail){// chip->ecc.layout->oobavail >= 8) {
	...
	if (nand_block_bad_old) {
		...
		/*fixme priv_nand->scan_bbt(meminfo);*/
	}
