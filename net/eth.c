...
extern int fh81_gmac_initialize(bd_t *);
extern int fh81_enc28j60_initialize(bd_t *bis);
...
#endif
#if defined(CONFIG_FH81_GMAC)
	fh81_gmac_initialize(bis);
#else
#if defined(CONFIG_ENC28J60)
	fh81_enc28j60_initialize(bis);	
#endif
#endif
	if (!eth_devices) {
