...
void iomux_init(void)
{
	...
	SET_REG(PAD_PMU_PAD_SD1_CLCK_CFG, 0x110); /*ssi1_clk*/
	SET_REG(PAD_PMU_PAD_SD1_DATA_0_CFG, 0x111010); /*ssi1_txd*/
	SET_REG(PAD_PMU_PAD_SD1_DATA_1_CFG, 0x121110); /*ssi1_csn_0*/
	SET_REG(PAD_PMU_PAD_SD1_DATA_2_CFG, 0x121110); /*ssi1_csn_1*/
	SET_REG(PAD_PMU_PAD_SD1_CMD_RSP_CFG, 0x111010); /*ssi1_rxd*/

	SET_REG(PAD_PMU_PAD_SD1_CD_CFG, 0x121110); /*gpio58*/
	SET_REG(PAD_PMU_PAD_SD1_WP_CFG, 0x121110); /*gpio59*/
