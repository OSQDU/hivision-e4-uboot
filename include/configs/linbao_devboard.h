...
#define CONFIG_FH_SERIAL_CONSOLE    0
...
#define CONFIG_FH_SPI_NAND
#endif
#ifdef CONFIG_WRITE_NAND_IN_NOR
#define CONFIG_FH_SPI_NAND
#endif
#ifdef CONFIG_FH_SPI_NAND
# define CONFIG_SYS_MAX_NAND_DEVICE	2
/*# define CONFIG_SPI_NAND_BBT */
# define CONFIG_SPI_NAND_CS		0
# define CONFIG_CMD_SPINAND
#ifndef CONFIG_WRITE_NAND_IN_NOR
# define CONFIG_SPI_NAND_BUS		0
# define CONFIG_SYS_SPI_WRITE_TOUT	(5*CONFIG_SYS_HZ)
# define CONFIG_SF_DEFAULT_SPEED	6750000			/* 6.75M */
# define CONFIG_SPI_NAND_ENV_OFFSET	0x40000          /*n*256K*/
...
#else
#define CONFIG_BOOTCOMMAND	"sf probe 0; sf read 0xA1000000 0x80000 0x300000; bootm"
#endif
...
#else
#define CONFIG_SPL_SPINAND_SUPPORT
#endif

#endif //CONFIG_SPL

//	AES
#define CONFIG_FH_AES
#define CONFIG_FH_ALGORITHM_CORE
#define CONFIG_HIK_AES_API
