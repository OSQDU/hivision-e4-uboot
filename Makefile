...
wudang_devboard_config	:	unconfig
	$(MKCONFIG) $(@:_config=) arm fh wudang_devboard Fullhan fh

fh62_devboard_config	: unconfig
	$(MKCONFIG) $(@:_config=) arm fh fh62_devboard Fullhan fh

linbao_fpga_config	: unconfig
	$(MKCONFIG) $(@:_config=) arm fh linbao_fpga Fullhan fh
	
linbao_devboard_config	: unconfig
	$(MKCONFIG) $(@:_config=) arm fh linbao_devboard Fullhan fh

#########################################################################
## CK810 Systems
#########################################################################
HK-2014-IPC_config	:	unconfig
	$(MKCONFIG) $(@:_config=) C-SKY CK810 HK-2014-IPC Fullhan HK-2014
